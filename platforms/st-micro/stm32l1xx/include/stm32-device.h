...
/*
 * This header provides device specific definitions for the STM32L1XX
...
#if (TARGET_DEVICE == STM32L152RC)
#include "stm32l152xc.h"

// No vendor header available.
#else
#error ("STM32L1XX Device Not Currently Supported");
#endif
...
/**
 * Initialises the STM32 serial debug console using USART1 and
 ...
 * return value.
 * @param dmaUnit This is the DMA unit to which the interrupt service
 *     routine is to be attached.
 * @param dmaChannel This is the DMA channel to which the interrupt
 *     service routine is to be attached, numbered from 1 to 7 for
 *     DMA unit 1 and 1 to 5 for DMA unit 2.
