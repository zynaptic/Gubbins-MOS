...
def parseCommandLine():
    parser = argparse.ArgumentParser(
        ...
        + "for specific STM32L1XX devices.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    parser.add_argument(
        "--device", default="STM32L152RC", help="the name of the target device"
    )
    parser.add_argument(
...
deviceParameterTable = {
    "STM32L152RC": {
        "TARGET_DEVICE": "STM32L152RC",
        "FLASH_SIZE": "256K",
        "RAM_SIZE": "32K",
        "RAM_ADDR_TOP": "0x20008000",
        "RAM_RESERVED": "0x1000",
    }
}
